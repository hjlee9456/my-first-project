...
PATCHES_LOG = [
    ("v1.0.3", "2026-09-22", [
        "지출 등록에 「원아별로 나누기」를 더함 — 원아마다 그 세목 잔액을 보며 금액을 정할 수 있음",
        "「잔액까지만 나누기」를 누르면 모자란 아이는 잔액에 맞춰지고 남는 몫이 운영비 부담분으로 넘어감",
        "4분기 잔액 부족 알림이 그 버튼을 가리키도록 문구를 고침",
    ]),
    ("v1.0.2", "2026-09-22", [
        "새 회계연도를 다시 만들 때 그 해에 등록한 원아가 사라지던 것을 바로잡음",
        "퇴소 정산에서 「포함」에 체크해도 사용액이 0원이던 것을 바로잡음",
        "입학준비금은 협의 금액을 적기 전까지 「협의 필요」로 두고 반환 합계에서 뺌",
        "협의 금액에 음수를 적을 수 없게 함",
        "금액 칸에 잘못 적으면 0원으로 바뀌어 그 원아가 빠지던 것을 막음",
        "검증의 「장부 차액」과 「돌려줄 돈」이 왜 다른지 한 줄로 맞춰 보여 줌",
        "두 번에 나눠 돌려준 경우 날짜별로 적도록 함",
        "중간퇴소 정산서의 CSV를 화면과 같은 기준으로 맞춤",
        "세목을 모두 꺼도 예전 기록을 고칠 수 있게 함",
        "반환액이 연간 누계임을 밝히고, 반기끼리 더하지 말라고 안내",
        "인쇄물에서 긴 계산식이 잘리던 것을 고침",
    ]),
    ("v1.0.1", "2026-09-21", [
        ...
        "입학준비금 협의 금액이 안내문·CSV·연말 정산서에 모두 반영되도록 함",
